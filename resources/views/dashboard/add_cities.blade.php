                  ...
                  <div class="col-lg-12">
                    <div class="p-5">
                      <div class="text-center">
                        <h1 class="h4 text-gray-900 mb-4"> اضافة مدينة جديدة </h1>
                      </div>
                      <form class="user" method="post" action="{{ route('dashboard.add_cities') }}">
                        @csrf
                        ...
                        <div class="form-group text-right">
                            ...
                            <select id="state_id" name="state_id" class="form-control text-right">
